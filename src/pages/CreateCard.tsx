...
export const CreateCard = ({ isEditing = false }: CreateCardProps) => {
  ...
  // Use a generated card
  const useGeneratedCard = (card: any) => {
    setQuestion(card.question);
    setAnswer(card.answer);
    if (card.hint) {
      setHint(card.hint);
  ...
  const addAllGeneratedCards = () => {
    if (!deckId || generatedCards.length === 0) return;
            ...
            {!isEditing && (
              <div className="flex justify-end mb-4">
                <button
                  ...
                  className="btn bg-purple-500 text-white hover:bg-purple-600 focus:ring-purple-500"
                >
            ...
            {!generatedCards.length ? (
              ...
              <div>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Select a card to use or add all cards to your deck.
                </p>
                ...
                <div className="space-y-4 mb-6 max-h-[50vh] overflow-y-auto">
                  {generatedCards.map((card, index) => (
                    <div 
                      key={index}
                      className="border border-gray-300 dark:border-gray-600 rounded-lg overflow-hidden cursor-pointer hover:border-primary-500 dark:hover:border-primary-500 transition-colors"
                      onClick={() => useGeneratedCard(card)}
                    >
                      <div className="bg-white dark:bg-gray-800 p-4">
